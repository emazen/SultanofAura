...
export interface Order {
  ...
  currency?: 'TRY' | null;
  shipping?: {
    carrier?: ('yurtici' | 'aras' | 'mng' | 'surat' | 'ptt' | 'other') | null;
...
export interface Product {
  ...
  priceInTRYEnabled?: boolean | null;
  priceInTRY?: number | null;
  /**
   * Boş bırakılırsa toptan müşteriler perakende fiyatı görür.
   */
  wholesalePriceInTRY?: number | null;
...
export interface VariantsSelect<T extends boolean = true> {
  ...
  priceInTRYEnabled?: T;
  priceInTRY?: T;
  wholesalePriceInTRY?: T;
  minWholesaleQuantity?: T;
  trendyolBarcode?: T;
  updatedAt?: T;
  createdAt?: T;
  deletedAt?: T;
